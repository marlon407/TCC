...
\end{lstlisting}
 ...
 A consulta ilustrada do trecho de código \ref{lst:query-graph} retorna como resposta lista a de todos os itens cadastrados na base de dados. Note que a resposta contém apenas os atributos que a consulta requisitou:
